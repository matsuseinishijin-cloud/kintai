// ── 職種・雇用形態 ────────────────────────────────────────────────────────────
export const ROLES = ["医療事務", "理学療法士", "AT", "看護師", "リハマネ", "放射線技師"];
...
// アプリ自体へのアクセス制限用パスワード（打刻画面をどこでも開けてしまうのを防ぐ目的）
// 従業員のログインパスワードとは別物。院内スタッフだけに口頭等で共有してください。
export const ACCESS_PASSWORD = "0819";
