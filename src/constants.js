...
export const LV_REQ_MAP = { id:"id", "従業員id":"empId", "日付":"date", "区分":"half", "有休開始":"leaveStart", "有休終了":"leaveEnd", "休憩":"leaveBreak", "理由":"reason", "状態":"status", "申請日時":"createdAt" };
...
export const OT_MAP = { id:"id", "従業員id":"empId", "日付":"date", "シフト終了":"shiftEnd", "申請退勤":"requestedEnd", "理由":"reason", "状態":"status", "種別":"type" };
